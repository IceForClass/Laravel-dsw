<div class="md:col-span-1 bg-gray-800 p-6 rounded-lg shadow-md border border-gray-600 self-start transition duration-300 hover:shadow-lg">
    ...
    <form method="POST" action="/dashboard">
        ...
        <div class="pt-3">
            <button type="submit"
                class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200">Contribute!</button>
        </div>
    </form>
</div>
