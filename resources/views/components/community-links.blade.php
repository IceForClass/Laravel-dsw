    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                @if ($links->isEmpty())
                    <div class="bg-yellow-200 border-l-4 border-yellow-600 text-yellow-800 p-4 mb-4 dark:bg-yellow-800 dark:border-yellow-500 dark:text-yellow-200" role="alert">
